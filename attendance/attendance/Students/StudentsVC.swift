...
//        addStudentButton.circularButton()
        addStudentBtn.setTitle("أضف طالب", for: .normal)
    ...
    private func setupStackView() {
        ...
        attendanceScreenBtn.setTitle("الأيام", for: .normal)
