...
//  attendance
//
//  Created by ibrahim asiri on 29/03/1443 AH.
//
...
class AttendanceDetailVC: UIViewController {
    ...
    private func setupLbls() {
        ...
        presentNumbersLbl.text = "✅: \(presentNum)"
        absentNumbersLbl.text = "❌: \(absentNum)"
...
extension AttendanceDetailVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.presentOrAbsent.text = students[indexPath.row].isPresent ? "✅" : "❌"
