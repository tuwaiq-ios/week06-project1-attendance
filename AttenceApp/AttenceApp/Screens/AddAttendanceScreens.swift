//
//  AddAttendanceScreens.swift
//  AttenceApp
//
//  Created by Kholod Sultan on 01/04/1443 AH.
//
...
class AddAttendanceScreen: UIViewController {
    ...
    let createAttendanceListButton: UIButton = {
        ...
        btn.setTitle("Create Attendance List🗓", for: .normal)
...
//        }
    ...
    private func setupButton() {
        ...
        createAttendanceListButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20).isActive = true
        createAttendanceListButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20).isActive = true
        createAttendanceListButton.heightAnchor.constraint(equalToConstant: 45).isActive = true
    }
