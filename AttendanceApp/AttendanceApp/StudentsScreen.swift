...
class StudentsScreen: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "1234")
    ...
    private func setupStackView() {
        ...
        attendanceScreenButton.setTitleColor(.systemCyan, for: .normal)
        ...
        studentsButton.setTitleColor(.systemGray6, for: .normal)
        
        let stackView = UIStackView(arrangedSubviews: [studentsButton, attendanceScreenButton])
        stackView.backgroundColor = .systemGray2.withAlphaComponent(0.9)
