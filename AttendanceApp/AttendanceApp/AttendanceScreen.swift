...
class AttendanceScreen: UIViewController {
    ...
    private func setupStackView() {
        ...
        daysButton.setTitleColor(.systemIndigo, for: .normal)
        studentsScreenButton.setTitle("Students", for: .normal)
        studentsScreenButton.setTitleColor(.systemIndigo, for: .normal)
    ...
    private func setupButton() {
        ...
        addDataButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -40).isActive = true
