//
//  AddAttendanceScreen.swift
//  AttendanceApp
//
//  Created by Sana Alshahrani on 30/03/1443 AH.
//
...
class AddAttendanceScreen: UIViewController {
    ...
    let createAttendanceListButton: UIButton = {
        ...
        btn.setTitle("Add Attendance", for: .normal)
    ...
    private func setupButton() {
        ...
        createAttendanceListButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 70).isActive = true
        createAttendanceListButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -70).isActive = true
        createAttendanceListButton.heightAnchor.constraint(equalToConstant: 70).isActive = true
    }
